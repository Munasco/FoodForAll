...
import { StyleSheet, Text, View, TextInput, 
  TouchableHighlight, KeyboardAvoidingView, Button, Alert, ActivityIndicator, Modal} from 'react-native';
...
export default function SignInScreen (props) {
  ...
  const modalForgotPassword = (
        ...
        <KeyboardAvoidingView style={tailwind("flex flex-grow w-full h-full items-center justify-center")}>
          <View style={tailwind("rounded-lg bg-white p-6")}>
            ...
            <TextInput
              ...
              style={tailwind("w-64 mb-2 rounded-sm p-3 bg-gray-300 border-gray-400 border")}
              placeholder="Email"
              value={state.email}
            ...
            <View style= {tailwind("w-56 self-center mb-2 rounded-sm p-3")}>
              <Buttons
                color="#000000"
                title="Reset"
                textStyle={tailwind("text-white text-xl")}
                onPress={() => resetPassword()}
              />
            </View> 
            <TouchableHighlight
              style={{ ...tailwind("w-full self-center p-2 rounded-lg bg-blue-800"), backgroundColor: "#2196F3" }}
              onPress={() => {
    ...
    return (
      <View style={tailwind("flex-grow flex flex-col my-24 items-center p-12 justify-center")} >  
        <TextInput
        ...
        />
        <TextInput
          style={tailwind("w-full mb-5 rounded-sm p-3 bg-gray-300 border-gray-400 border")}
        ...
        />   
        <Buttons testID="login-btn" onPress={userLogin} title={'Sign In'}/> 

        <Text 
            style={tailwind("text-center mt-2 text-orange-400")}
        ...
        <View style={tailwind("flex-grow flex items-center justify-center flex-row")}>               
            <Entypo name="chat" size={24} color="black" onPress={() => props.navigation.navigate("Support")}/>
        </View>  
